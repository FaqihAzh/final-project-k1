...
const SearchResultsPage = () => {
  ...
  return (
    <div className="w-screen min-h-screen bg-softGrey">
      <div className="mt-0 md:mt-5 pt-24 pb-32 px-4 md:px-12 lg:px-24 lg:pt-28 flex flex-col gap-4 max-w-[1440px] mx-auto">
        ...
        {results.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-4 md:gap-y-8">
            {results.map((course) => (
