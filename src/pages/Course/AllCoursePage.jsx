...
const AllCoursePage = () => {
  ...
  return (
    <>
      <div className="w-screen min-h-screen bg-softGrey overflow-hidden">
        <div className="max-w-[1440px] mx-auto pt-24 pb-12 mt-0 lg:mt-4 px-4 md:px-12 lg:px-24 lg:pt-28 bg-softGrey flex flex-col gap-4">
