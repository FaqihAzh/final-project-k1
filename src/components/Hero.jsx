...
const Hero = () => {
  return (
    <>
      <div className="flex flex-col-reverse lg:flex-row w-screen bg-lightBlue py-24 px-4 md:px-12 lg:px-24 items-center gap-8 lg:gap-4 min-h-screen">
        ...
        <div className="flex justify-center md:hidden lg:flex flex-1 z-40">
          <FadeIn delay={0.5} direction="down">
            <img
              src={headerIllustration}
              alt="headerIllustration"
              className="w-[90%] lg:w-full h-auto"
            />
          </FadeIn>
        </div>
