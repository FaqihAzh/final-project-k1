...
const Advantages = () => {
  return (
    <>
      <div className="px-4 md:px-12 lg:px-24 py-8 flex flex-col md:flex-row items-center md:items-center gap-4 bg-softGrey justify-around md:justify-between flex-wrap">
        <FadeIn
          delay={0.2}
          direction="right"
